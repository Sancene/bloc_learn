...
class _ClusterizedPlacemarkCollectionExampleState
  ...
  final MapObjectId clusterizedPlacemarkCollectionId = MapObjectId(
      'clusterized_placemark_collection');
  final MapObjectId largeClusterizedPlacemarkCollectionId = MapObjectId(
          ...
          Expanded(
              child: YandexMap(
                  ...
                  onMapCreated: (
                    ...
                    controller.moveCamera(CameraUpdate.newCameraPosition(CameraPosition(target: Point(latitude: 55.756, longitude: 37.618))));
                                ...
                                onPressed: () async {
                                  ...
                                  final clusterizedPlacemarkCollection = ClusterizedPlacemarkCollection(
                                    ...
                                    onClusterTap: (
                                        ClusterizedPlacemarkCollection self,
                                        Cluster cluster) {
                                      //controller.moveCamera(CameraUpdate(TapDownDetails.globalPosition)),
